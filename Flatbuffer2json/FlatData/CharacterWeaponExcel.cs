...
public struct CharacterWeaponExcel : IFlatbufferObject
{
  ...
  public FlatData.Tag Tags(int j) { int o = __p.__offset(24); return o != 0 ? (FlatData.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.Tag> GetTagsBytes() { return __p.__vector_as_span<FlatData.Tag>(24, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public FlatData.Tag[] GetTagsArray() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.Tag[] a = new FlatData.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatData.EquipmentOptionType StatType(int j) { int o = __p.__offset(34); return o != 0 ? (FlatData.EquipmentOptionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.EquipmentOptionType)0; }
  public int StatTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.EquipmentOptionType> GetStatTypeBytes() { return __p.__vector_as_span<FlatData.EquipmentOptionType>(34, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public FlatData.EquipmentOptionType[] GetStatTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.EquipmentOptionType[] a = new FlatData.EquipmentOptionType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.EquipmentOptionType)__p.bb.GetInt(p + i * 4); } return a; }
...
static public class CharacterWeaponExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 24 /*Tags*/, 4 /*FlatData.Tag*/, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 34 /*StatType*/, 4 /*FlatData.EquipmentOptionType*/, false)
