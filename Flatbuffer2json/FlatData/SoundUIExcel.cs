...
public struct SoundUIExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.SoundUIExcel> CreateSoundUIExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<FlatData.SoundUIExcel> EndSoundUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.SoundUIExcel>(o);
  }
}
