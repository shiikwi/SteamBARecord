...
public struct VoiceCommonExcel : IFlatbufferObject
{
  ...
  public FlatData.VoiceEvent VoiceEvent { get { int o = __p.__offset(4); return o != 0 ? (FlatData.VoiceEvent)__p.bb.GetInt(o + __p.bb_pos) : FlatData.VoiceEvent.OnTSA; } }
  ...
  public static Offset<FlatData.VoiceCommonExcel> CreateVoiceCommonExcel(FlatBufferBuilder builder,
      FlatData.VoiceEvent VoiceEvent = FlatData.VoiceEvent.OnTSA,
      long Rate = 0,
  ...
  public static void AddVoiceEvent(FlatBufferBuilder builder, FlatData.VoiceEvent voiceEvent) { builder.AddInt(0, (int)voiceEvent, 0); }
  ...
  public static Offset<FlatData.VoiceCommonExcel> EndVoiceCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.VoiceCommonExcel>(o);
  }
}
...
static public class VoiceCommonExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*VoiceEvent*/, 4 /*FlatData.VoiceEvent*/, 4, false)
