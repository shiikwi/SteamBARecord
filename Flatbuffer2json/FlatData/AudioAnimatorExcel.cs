...
public struct AudioAnimatorExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.AudioAnimatorExcel> CreateAudioAnimatorExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.AudioAnimatorExcel> EndAudioAnimatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.AudioAnimatorExcel>(o);
  }
}
