...
public struct IdCardBackgroundExcel : IFlatbufferObject
{
  ...
  public FlatData.Rarity Rarity { get { int o = __p.__offset(6); return o != 0 ? (FlatData.Rarity)__p.bb.GetInt(o + __p.bb_pos) : FlatData.Rarity.N; } }
  ...
  public static Offset<FlatData.IdCardBackgroundExcel> CreateIdCardBackgroundExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddRarity(FlatBufferBuilder builder, FlatData.Rarity rarity) { builder.AddInt(1, (int)rarity, 0); }
  ...
  public static Offset<FlatData.IdCardBackgroundExcel> EndIdCardBackgroundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.IdCardBackgroundExcel>(o);
  }
}
...
static public class IdCardBackgroundExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*Rarity*/, 4 /*FlatData.Rarity*/, 4, false)
