...
public struct EventContentTreasureRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentTreasureRewardExcel> CreateEventContentTreasureRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.EventContentTreasureRewardExcel> EndEventContentTreasureRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentTreasureRewardExcel>(o);
  }
}
