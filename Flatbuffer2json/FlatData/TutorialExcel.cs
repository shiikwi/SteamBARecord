...
public struct TutorialExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.TutorialExcel> CreateTutorialExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<FlatData.TutorialExcel> EndTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.TutorialExcel>(o);
  }
}
