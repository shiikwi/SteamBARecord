...
public struct CharacterPotentialRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.PotentialStatBonusRateType RequirePotentialStatType(int j) { int o = __p.__offset(6); return o != 0 ? (FlatData.PotentialStatBonusRateType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.PotentialStatBonusRateType)0; }
  public int RequirePotentialStatTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.PotentialStatBonusRateType> GetRequirePotentialStatTypeBytes() { return __p.__vector_as_span<FlatData.PotentialStatBonusRateType>(6, 4); }
#else
  public ArraySegment<byte>? GetRequirePotentialStatTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public FlatData.PotentialStatBonusRateType[] GetRequirePotentialStatTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.PotentialStatBonusRateType[] a = new FlatData.PotentialStatBonusRateType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.PotentialStatBonusRateType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.CharacterPotentialRewardExcel> CreateCharacterPotentialRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateRequirePotentialStatTypeVector(FlatBufferBuilder builder, FlatData.PotentialStatBonusRateType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateRequirePotentialStatTypeVectorBlock(FlatBufferBuilder builder, FlatData.PotentialStatBonusRateType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRequirePotentialStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.PotentialStatBonusRateType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRequirePotentialStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.PotentialStatBonusRateType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.CharacterPotentialRewardExcel> EndCharacterPotentialRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterPotentialRewardExcel>(o);
  }
}
...
static public class CharacterPotentialRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*RequirePotentialStatType*/, 4 /*FlatData.PotentialStatBonusRateType*/, false)
