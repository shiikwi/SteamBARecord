...
public struct ScenarioTransitionExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ScenarioTransitionExcel> CreateScenarioTransitionExcel(FlatBufferBuilder builder,
      uint Name = 0,
  ...
  public static Offset<FlatData.ScenarioTransitionExcel> EndScenarioTransitionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ScenarioTransitionExcel>(o);
  }
}
