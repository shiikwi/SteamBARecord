...
public struct EventContentTreasureRoundExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.EventContentTreasureRoundExcel> CreateEventContentTreasureRoundExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.EventContentTreasureRoundExcel> EndEventContentTreasureRoundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentTreasureRoundExcel>(o);
  }
}
