...
public struct ScenarioEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ScenarioEffectExcel> CreateScenarioEffectExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.ScenarioEffectExcel> EndScenarioEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ScenarioEffectExcel>(o);
  }
}
