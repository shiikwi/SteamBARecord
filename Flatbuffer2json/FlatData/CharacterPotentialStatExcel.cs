...
public struct CharacterPotentialStatExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.CharacterPotentialStatExcel> CreateCharacterPotentialStatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.CharacterPotentialStatExcel> EndCharacterPotentialStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterPotentialStatExcel>(o);
  }
}
