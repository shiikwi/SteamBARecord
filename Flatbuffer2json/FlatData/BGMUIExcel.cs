...
public struct BGMUIExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.BGMUIExcel> CreateBGMUIExcel(FlatBufferBuilder builder,
      uint UIPrefab = 0,
      long BGMId = 0,
      long BGMId2nd = 0,
      long BGMId3rd = 0,
  ...
  public static Offset<FlatData.BGMUIExcel> EndBGMUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.BGMUIExcel>(o);
  }
}
