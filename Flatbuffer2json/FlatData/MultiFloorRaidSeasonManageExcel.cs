...
public struct MultiFloorRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.MultiFloorRaidSeasonManageExcel> CreateMultiFloorRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static Offset<FlatData.MultiFloorRaidSeasonManageExcel> EndMultiFloorRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MultiFloorRaidSeasonManageExcel>(o);
  }
}
