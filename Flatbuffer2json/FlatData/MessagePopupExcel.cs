...
public struct MessagePopupExcel : IFlatbufferObject
{
  ...
  public FlatData.MessagePopupLayout MessagePopupLayout { get { int o = __p.__offset(6); return o != 0 ? (FlatData.MessagePopupLayout)__p.bb.GetInt(o + __p.bb_pos) : FlatData.MessagePopupLayout.TextOnly; } }
  public FlatData.MessagePopupImagePositionType OrderType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.MessagePopupImagePositionType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.MessagePopupImagePositionType.ImageFirst; } }
  ...
  public FlatData.MessagePopupButtonType Button(int j) { int o = __p.__offset(22); return o != 0 ? (FlatData.MessagePopupButtonType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatData.MessagePopupButtonType)0; }
  public int ButtonLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatData.MessagePopupButtonType> GetButtonBytes() { return __p.__vector_as_span<FlatData.MessagePopupButtonType>(22, 4); }
#else
  public ArraySegment<byte>? GetButtonBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public FlatData.MessagePopupButtonType[] GetButtonArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatData.MessagePopupButtonType[] a = new FlatData.MessagePopupButtonType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatData.MessagePopupButtonType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatData.MessagePopupExcel> CreateMessagePopupExcel(FlatBufferBuilder builder,
      uint StringId = 0,
      FlatData.MessagePopupLayout MessagePopupLayout = FlatData.MessagePopupLayout.TextOnly,
      FlatData.MessagePopupImagePositionType OrderType = FlatData.MessagePopupImagePositionType.ImageFirst,
  ...
  public static void AddMessagePopupLayout(FlatBufferBuilder builder, FlatData.MessagePopupLayout messagePopupLayout) { builder.AddInt(1, (int)messagePopupLayout, 0); }
  public static void AddOrderType(FlatBufferBuilder builder, FlatData.MessagePopupImagePositionType orderType) { builder.AddInt(2, (int)orderType, 0); }
  ...
  public static VectorOffset CreateButtonVector(FlatBufferBuilder builder, FlatData.MessagePopupButtonType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateButtonVectorBlock(FlatBufferBuilder builder, FlatData.MessagePopupButtonType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateButtonVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatData.MessagePopupButtonType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateButtonVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatData.MessagePopupButtonType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatData.MessagePopupExcel> EndMessagePopupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MessagePopupExcel>(o);
  }
}
...
static public class MessagePopupExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*MessagePopupLayout*/, 4 /*FlatData.MessagePopupLayout*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*OrderType*/, 4 /*FlatData.MessagePopupImagePositionType*/, 4, false)
      ...
      && verifier.VerifyVectorOfData(tablePos, 22 /*Button*/, 4 /*FlatData.MessagePopupButtonType*/, false)
