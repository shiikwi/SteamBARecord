...
public struct EmblemExcel : IFlatbufferObject
{
  ...
  public FlatData.EmblemDisplayType DisplayType { get { int o = __p.__offset(38); return o != 0 ? (FlatData.EmblemDisplayType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EmblemDisplayType.Always; } }
  ...
  public FlatData.EmblemCheckPassType CheckPassType { get { int o = __p.__offset(46); return o != 0 ? (FlatData.EmblemCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EmblemCheckPassType.None; } }
  ...
  public static void AddDisplayType(FlatBufferBuilder builder, FlatData.EmblemDisplayType displayType) { builder.AddInt(17, (int)displayType, 0); }
  ...
  public static void AddCheckPassType(FlatBufferBuilder builder, FlatData.EmblemCheckPassType checkPassType) { builder.AddInt(21, (int)checkPassType, 0); }
...
static public class EmblemExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 38 /*DisplayType*/, 4 /*FlatData.EmblemDisplayType*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 46 /*CheckPassType*/, 4 /*FlatData.EmblemCheckPassType*/, 4, false)
