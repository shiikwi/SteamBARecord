...
public struct OperatorExcel : IFlatbufferObject
{
  ...
  public FlatData.OperatorCondition OperatorCondition { get { int o = __p.__offset(8); return o != 0 ? (FlatData.OperatorCondition)__p.bb.GetInt(o + __p.bb_pos) : FlatData.OperatorCondition.None; } }
  ...
  public static Offset<FlatData.OperatorExcel> CreateOperatorExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      StringOffset GroupIdOffset = default(StringOffset),
      FlatData.OperatorCondition OperatorCondition = FlatData.OperatorCondition.None,
  ...
  public static void AddOperatorCondition(FlatBufferBuilder builder, FlatData.OperatorCondition operatorCondition) { builder.AddInt(2, (int)operatorCondition, 0); }
  ...
  public static Offset<FlatData.OperatorExcel> EndOperatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.OperatorExcel>(o);
  }
}
...
static public class OperatorExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*OperatorCondition*/, 4 /*FlatData.OperatorCondition*/, 4, false)
