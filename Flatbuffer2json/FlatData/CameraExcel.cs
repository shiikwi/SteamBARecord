...
public struct CameraExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.CameraExcel> CreateCameraExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatData.CameraExcel> EndCameraExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CameraExcel>(o);
  }
}
