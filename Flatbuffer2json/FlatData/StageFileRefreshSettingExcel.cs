...
public struct StageFileRefreshSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.StageFileRefreshSettingExcel> CreateStageFileRefreshSettingExcel(FlatBufferBuilder builder,
      long GroundId = 0,
  ...
  public static Offset<FlatData.StageFileRefreshSettingExcel> EndStageFileRefreshSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.StageFileRefreshSettingExcel>(o);
  }
}
