...
public struct VoiceLogicEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.VoiceLogicEffectExcel> CreateVoiceLogicEffectExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatData.VoiceLogicEffectExcel> EndVoiceLogicEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.VoiceLogicEffectExcel>(o);
  }
}
