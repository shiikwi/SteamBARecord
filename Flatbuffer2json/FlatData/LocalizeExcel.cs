...
public struct LocalizeExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.LocalizeExcel> CreateLocalizeExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<FlatData.LocalizeExcel> EndLocalizeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.LocalizeExcel>(o);
  }
}
