...
public struct MissionEmergencyCompleteExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.MissionEmergencyCompleteExcel> CreateMissionEmergencyCompleteExcel(FlatBufferBuilder builder,
      long MissionId = 0,
  ...
  public static Offset<FlatData.MissionEmergencyCompleteExcel> EndMissionEmergencyCompleteExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MissionEmergencyCompleteExcel>(o);
  }
}
