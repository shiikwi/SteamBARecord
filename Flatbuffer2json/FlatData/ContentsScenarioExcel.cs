...
public struct ContentsScenarioExcel : IFlatbufferObject
{
  ...
  public FlatData.ScenarioContentType ScenarioContentType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.ScenarioContentType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ScenarioContentType.Prologue; } }
  ...
  public static Offset<FlatData.ContentsScenarioExcel> CreateContentsScenarioExcel(FlatBufferBuilder builder,
      uint Id = 0,
      uint LocalizeId = 0,
      int DisplayOrder = 0,
      FlatData.ScenarioContentType ScenarioContentType = FlatData.ScenarioContentType.Prologue,
  ...
  public static void AddScenarioContentType(FlatBufferBuilder builder, FlatData.ScenarioContentType scenarioContentType) { builder.AddInt(3, (int)scenarioContentType, 0); }
  ...
  public static Offset<FlatData.ContentsScenarioExcel> EndContentsScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ContentsScenarioExcel>(o);
  }
}
...
static public class ContentsScenarioExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*ScenarioContentType*/, 4 /*FlatData.ScenarioContentType*/, 4, false)
