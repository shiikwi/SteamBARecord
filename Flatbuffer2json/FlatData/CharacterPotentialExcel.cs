...
public struct CharacterPotentialExcel : IFlatbufferObject
{
  ...
  public FlatData.PotentialStatBonusRateType PotentialStatBonusRateType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.PotentialStatBonusRateType.None; } }
  public bool IsUnnecessaryStat { get { int o = __p.__offset(10); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }

  public static Offset<FlatData.CharacterPotentialExcel> CreateCharacterPotentialExcel(FlatBufferBuilder builder,
      long Id = 0,
      long PotentialStatGroupId = 0,
      FlatData.PotentialStatBonusRateType PotentialStatBonusRateType = FlatData.PotentialStatBonusRateType.None,
  ...
  public static void AddPotentialStatBonusRateType(FlatBufferBuilder builder, FlatData.PotentialStatBonusRateType potentialStatBonusRateType) { builder.AddInt(2, (int)potentialStatBonusRateType, 0); }
  ...
  public static Offset<FlatData.CharacterPotentialExcel> EndCharacterPotentialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CharacterPotentialExcel>(o);
  }
}
...
static public class CharacterPotentialExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*PotentialStatBonusRateType*/, 4 /*FlatData.PotentialStatBonusRateType*/, 4, false)
