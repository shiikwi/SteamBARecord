...
public struct EventContentNotifyExcel : IFlatbufferObject
{
  ...
  public FlatData.EventNotifyType EventNotifyType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.EventNotifyType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EventNotifyType.RewardIncreaseEvent; } }
  public FlatData.EventTargetType EventTargetType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.EventTargetType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EventTargetType.WeekDungeon; } }
  public FlatData.EventTargetType ShortcutEventTargetType { get { int o = __p.__offset(14); return o != 0 ? (FlatData.EventTargetType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EventTargetType.WeekDungeon; } }
  public bool IsShortcutEnable { get { int o = __p.__offset(16); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }

  public static Offset<FlatData.EventContentNotifyExcel> CreateEventContentNotifyExcel(FlatBufferBuilder builder,
      int Id = 0,
      uint LocalizeEtcId = 0,
      StringOffset IconPathOffset = default(StringOffset),
      FlatData.EventNotifyType EventNotifyType = FlatData.EventNotifyType.RewardIncreaseEvent,
      FlatData.EventTargetType EventTargetType = FlatData.EventTargetType.WeekDungeon,
      FlatData.EventTargetType ShortcutEventTargetType = FlatData.EventTargetType.WeekDungeon,
  ...
  public static void AddEventNotifyType(FlatBufferBuilder builder, FlatData.EventNotifyType eventNotifyType) { builder.AddInt(3, (int)eventNotifyType, 0); }
  public static void AddEventTargetType(FlatBufferBuilder builder, FlatData.EventTargetType eventTargetType) { builder.AddInt(4, (int)eventTargetType, 0); }
  public static void AddShortcutEventTargetType(FlatBufferBuilder builder, FlatData.EventTargetType shortcutEventTargetType) { builder.AddInt(5, (int)shortcutEventTargetType, 0); }
  ...
  public static Offset<FlatData.EventContentNotifyExcel> EndEventContentNotifyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.EventContentNotifyExcel>(o);
  }
}
...
static public class EventContentNotifyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*EventNotifyType*/, 4 /*FlatData.EventNotifyType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*EventTargetType*/, 4 /*FlatData.EventTargetType*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*ShortcutEventTargetType*/, 4 /*FlatData.EventTargetType*/, 4, false)
