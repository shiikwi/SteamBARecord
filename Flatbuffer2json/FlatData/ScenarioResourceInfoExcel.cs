...
public struct ScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.ScenarioResourceInfoExcel> CreateScenarioResourceInfoExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.ScenarioResourceInfoExcel> EndScenarioResourceInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ScenarioResourceInfoExcel>(o);
  }
}
