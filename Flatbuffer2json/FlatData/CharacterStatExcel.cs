...
public struct CharacterStatExcel : IFlatbufferObject
{
  ...
  public FlatData.TerrainAdaptationStat StreetBattleAdaptation { get { int o = __p.__offset(154); return o != 0 ? (FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TerrainAdaptationStat.D; } }
  public FlatData.TerrainAdaptationStat OutdoorBattleAdaptation { get { int o = __p.__offset(156); return o != 0 ? (FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TerrainAdaptationStat.D; } }
  public FlatData.TerrainAdaptationStat IndoorBattleAdaptation { get { int o = __p.__offset(158); return o != 0 ? (FlatData.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : FlatData.TerrainAdaptationStat.D; } }
  ...
  public static void AddStreetBattleAdaptation(FlatBufferBuilder builder, FlatData.TerrainAdaptationStat streetBattleAdaptation) { builder.AddInt(75, (int)streetBattleAdaptation, 0); }
  public static void AddOutdoorBattleAdaptation(FlatBufferBuilder builder, FlatData.TerrainAdaptationStat outdoorBattleAdaptation) { builder.AddInt(76, (int)outdoorBattleAdaptation, 0); }
  public static void AddIndoorBattleAdaptation(FlatBufferBuilder builder, FlatData.TerrainAdaptationStat indoorBattleAdaptation) { builder.AddInt(77, (int)indoorBattleAdaptation, 0); }
...
static public class CharacterStatExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 154 /*StreetBattleAdaptation*/, 4 /*FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 156 /*OutdoorBattleAdaptation*/, 4 /*FlatData.TerrainAdaptationStat*/, 4, false)
      && verifier.VerifyField(tablePos, 158 /*IndoorBattleAdaptation*/, 4 /*FlatData.TerrainAdaptationStat*/, 4, false)
