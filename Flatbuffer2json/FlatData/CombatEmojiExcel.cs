...
public struct CombatEmojiExcel : IFlatbufferObject
{
  ...
  public FlatData.EmojiEvent EmojiEvent { get { int o = __p.__offset(6); return o != 0 ? (FlatData.EmojiEvent)__p.bb.GetInt(o + __p.bb_pos) : FlatData.EmojiEvent.EnterConver; } }
  ...
  public static Offset<FlatData.CombatEmojiExcel> CreateCombatEmojiExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      FlatData.EmojiEvent EmojiEvent = FlatData.EmojiEvent.EnterConver,
  ...
  public static void AddEmojiEvent(FlatBufferBuilder builder, FlatData.EmojiEvent emojiEvent) { builder.AddInt(1, (int)emojiEvent, 0); }
  ...
  public static Offset<FlatData.CombatEmojiExcel> EndCombatEmojiExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.CombatEmojiExcel>(o);
  }
}
...
static public class CombatEmojiExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*EmojiEvent*/, 4 /*FlatData.EmojiEvent*/, 4, false)
