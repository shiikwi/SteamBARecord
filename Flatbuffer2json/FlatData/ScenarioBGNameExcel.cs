...
public struct ScenarioBGNameExcel : IFlatbufferObject
{
  ...
  public FlatData.ScenarioBGType BGType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.ScenarioBGType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ScenarioBGType.None; } }
  ...
  public static Offset<FlatData.ScenarioBGNameExcel> CreateScenarioBGNameExcel(FlatBufferBuilder builder,
      uint Name = 0,
      FlatData.ProductionStep ProductionStep = FlatData.ProductionStep.ToDo,
      StringOffset BGFileNameOffset = default(StringOffset),
      FlatData.ScenarioBGType BGType = FlatData.ScenarioBGType.None,
  ...
  public static void AddBGType(FlatBufferBuilder builder, FlatData.ScenarioBGType bGType) { builder.AddInt(3, (int)bGType, 0); }
  ...
  public static Offset<FlatData.ScenarioBGNameExcel> EndScenarioBGNameExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ScenarioBGNameExcel>(o);
  }
}
...
static public class ScenarioBGNameExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*BGType*/, 4 /*FlatData.ScenarioBGType*/, 4, false)
