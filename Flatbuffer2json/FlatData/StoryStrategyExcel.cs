...
public struct StoryStrategyExcel : IFlatbufferObject
{
  ...
  public FlatData.StageTopography StageTopography { get { int o = __p.__offset(22); return o != 0 ? (FlatData.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : FlatData.StageTopography.Street; } }
  public FlatData.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(24); return o != 0 ? (FlatData.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : FlatData.StrategyEnvironment.None; } }
  public FlatData.ContentType ContentType { get { int o = __p.__offset(26); return o != 0 ? (FlatData.ContentType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ContentType.None; } }
  ...
  public static Offset<FlatData.StoryStrategyExcel> CreateStoryStrategyExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, FlatData.StageTopography stageTopography) { builder.AddInt(9, (int)stageTopography, 0); }
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, FlatData.StrategyEnvironment strategyEnvironment) { builder.AddInt(10, (int)strategyEnvironment, 0); }
  public static void AddContentType(FlatBufferBuilder builder, FlatData.ContentType contentType) { builder.AddInt(11, (int)contentType, 0); }
  ...
  public static Offset<FlatData.StoryStrategyExcel> EndStoryStrategyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.StoryStrategyExcel>(o);
  }
}
...
static public class StoryStrategyExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*StageTopography*/, 4 /*FlatData.StageTopography*/, 4, false)
      && verifier.VerifyField(tablePos, 24 /*StrategyEnvironment*/, 4 /*FlatData.StrategyEnvironment*/, 4, false)
      && verifier.VerifyField(tablePos, 26 /*ContentType*/, 4 /*FlatData.ContentType*/, 4, false)
