...
public struct MultiFloorRaidStageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.MultiFloorRaidStageExcel> CreateMultiFloorRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.MultiFloorRaidStageExcel> EndMultiFloorRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MultiFloorRaidStageExcel>(o);
  }
}
