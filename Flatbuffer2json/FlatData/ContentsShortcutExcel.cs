...
public struct ContentsShortcutExcel : IFlatbufferObject
{
  ...
  public FlatData.StageDifficulty ConquestMapDifficulty { get { int o = __p.__offset(20); return o != 0 ? (FlatData.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : FlatData.StageDifficulty.None; } }
  ...
  public static Offset<FlatData.ContentsShortcutExcel> CreateContentsShortcutExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      ...
      FlatData.StageDifficulty ConquestMapDifficulty = FlatData.StageDifficulty.None,
  ...
  public static void AddConquestMapDifficulty(FlatBufferBuilder builder, FlatData.StageDifficulty conquestMapDifficulty) { builder.AddInt(8, (int)conquestMapDifficulty, 0); }
  ...
  public static Offset<FlatData.ContentsShortcutExcel> EndContentsShortcutExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ContentsShortcutExcel>(o);
  }
}
...
static public class ContentsShortcutExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*ConquestMapDifficulty*/, 4 /*FlatData.StageDifficulty*/, 4, false)
