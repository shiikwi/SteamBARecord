...
public struct ServiceActionExcel : IFlatbufferObject
{
  ...
  public FlatData.ServiceActionType ServiceActionType { get { int o = __p.__offset(4); return o != 0 ? (FlatData.ServiceActionType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ServiceActionType.ClanCreate; } }
  ...
  public static Offset<FlatData.ServiceActionExcel> CreateServiceActionExcel(FlatBufferBuilder builder,
      FlatData.ServiceActionType ServiceActionType = FlatData.ServiceActionType.ClanCreate,
      bool IsLegacy = false,
      long GoodsId = 0) {
  ...
  public static void AddServiceActionType(FlatBufferBuilder builder, FlatData.ServiceActionType serviceActionType) { builder.AddInt(0, (int)serviceActionType, 0); }
  ...
  public static Offset<FlatData.ServiceActionExcel> EndServiceActionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.ServiceActionExcel>(o);
  }
}
...
static public class ServiceActionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*ServiceActionType*/, 4 /*FlatData.ServiceActionType*/, 4, false)
