...
public struct MiniGameDreamEndingRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.DreamMakerEndingRewardType DreamMakerEndingRewardType { get { int o = __p.__offset(10); return o != 0 ? (FlatData.DreamMakerEndingRewardType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.DreamMakerEndingRewardType.None; } }
  public FlatData.DreamMakerEndingType DreamMakerEndingType { get { int o = __p.__offset(12); return o != 0 ? (FlatData.DreamMakerEndingType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.DreamMakerEndingType.None; } }
  ...
  public static Offset<FlatData.MiniGameDreamEndingRewardExcel> CreateMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long EndingId = 0,
      uint LocalizeEtcId = 0,
      FlatData.DreamMakerEndingRewardType DreamMakerEndingRewardType = FlatData.DreamMakerEndingRewardType.None,
  ...
  public static void AddDreamMakerEndingRewardType(FlatBufferBuilder builder, FlatData.DreamMakerEndingRewardType dreamMakerEndingRewardType) { builder.AddInt(3, (int)dreamMakerEndingRewardType, 0); }
  public static void AddDreamMakerEndingType(FlatBufferBuilder builder, FlatData.DreamMakerEndingType dreamMakerEndingType) { builder.AddInt(4, (int)dreamMakerEndingType, 0); }
  ...
  public static Offset<FlatData.MiniGameDreamEndingRewardExcel> EndMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MiniGameDreamEndingRewardExcel>(o);
  }
}
...
static public class MiniGameDreamEndingRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*DreamMakerEndingRewardType*/, 4 /*FlatData.DreamMakerEndingRewardType*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*DreamMakerEndingType*/, 4 /*FlatData.DreamMakerEndingType*/, 4, false)
