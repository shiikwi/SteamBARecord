...
public struct MiniGameDreamTimelineExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.MiniGameDreamTimelineExcel> CreateMiniGameDreamTimelineExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.MiniGameDreamTimelineExcel> EndMiniGameDreamTimelineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MiniGameDreamTimelineExcel>(o);
  }
}
