...
public struct AddressableBlackListExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatData.AddressableBlackListExcel> CreateAddressableBlackListExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatData.AddressableBlackListExcel> EndAddressableBlackListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.AddressableBlackListExcel>(o);
  }
}
