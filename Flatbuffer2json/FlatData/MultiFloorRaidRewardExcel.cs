...
public struct MultiFloorRaidRewardExcel : IFlatbufferObject
{
  ...
  public FlatData.ParcelType ClearStageRewardParcelType { get { int o = __p.__offset(8); return o != 0 ? (FlatData.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.ParcelType.None; } }
  ...
  public static Offset<FlatData.MultiFloorRaidRewardExcel> CreateMultiFloorRaidRewardExcel(FlatBufferBuilder builder,
  ...
  public static void AddClearStageRewardParcelType(FlatBufferBuilder builder, FlatData.ParcelType clearStageRewardParcelType) { builder.AddInt(2, (int)clearStageRewardParcelType, 0); }
  ...
  public static Offset<FlatData.MultiFloorRaidRewardExcel> EndMultiFloorRaidRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.MultiFloorRaidRewardExcel>(o);
  }
}
...
static public class MultiFloorRaidRewardExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*ClearStageRewardParcelType*/, 4 /*FlatData.ParcelType*/, 4, false)
