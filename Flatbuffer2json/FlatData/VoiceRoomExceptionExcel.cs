...
public struct VoiceRoomExceptionExcel : IFlatbufferObject
{
  ...
  public FlatData.CVPrintType LinkedCharacterVoicePrintType { get { int o = __p.__offset(6); return o != 0 ? (FlatData.CVPrintType)__p.bb.GetInt(o + __p.bb_pos) : FlatData.CVPrintType.CharacterOverwrite; } }
  public long LinkedCostumeUniqueId { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static Offset<FlatData.VoiceRoomExceptionExcel> CreateVoiceRoomExceptionExcel(FlatBufferBuilder builder,
      long CostumeUniqueId = 0,
      FlatData.CVPrintType LinkedCharacterVoicePrintType = FlatData.CVPrintType.CharacterOverwrite,
  ...
  public static void AddLinkedCharacterVoicePrintType(FlatBufferBuilder builder, FlatData.CVPrintType linkedCharacterVoicePrintType) { builder.AddInt(1, (int)linkedCharacterVoicePrintType, 0); }
  ...
  public static Offset<FlatData.VoiceRoomExceptionExcel> EndVoiceRoomExceptionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatData.VoiceRoomExceptionExcel>(o);
  }
}
...
static public class VoiceRoomExceptionExcelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*LinkedCharacterVoicePrintType*/, 4 /*FlatData.CVPrintType*/, 4, false)
